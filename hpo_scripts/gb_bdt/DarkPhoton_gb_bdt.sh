hpogrid model_config recreate DarkPhoton_gb_bdt --script bdtTrain.py --model DarkPhoton_gb_bdt --param '{"run_mode":"grid"}'
...
# What is this?
hpogrid grid_config recreate grid_run --inDS user.ssevova:ZHyyD_v09_mc16a_ML --outDS user.ehofgard.BDTtest
hpogrid project recreate DarkPhoton_gb_bdt --model_config DarkPhoton_gb_bdt --search_space bdt_space --hpo_config nevergrad_max_auc --grid_config grid_run --scripts_path /afs/cern.ch/user/e/ehofgard/public/ZHdarkPhotonML/source/python
